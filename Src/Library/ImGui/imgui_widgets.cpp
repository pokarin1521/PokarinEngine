...
bool ImGui::Button(const char* label, const ImVec4& color, const ImVec2& size)
{
    PushStyleColor(ImGuiCol_Button, color);
    
    bool isPush = Button(label, size);
...
// Add multiple sliders on 1 line for compact edition of multiple componentList
...
// Edit colors componentList (each component in 0.0f..1.0f range).
